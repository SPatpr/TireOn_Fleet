...
const SignUpScreen = ({ navigation }) => {
  ...
  const handleRegister = async () => {
    if (!data.fullName || !data.companyName || !data.taxId || !data.email || !data.password) {
      ...
      >
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.action}>
            <FontAwesome name="user-o" color="#0A2342" size={20} />
            <TextInput
          ...
          <View style={styles.action}>
            <FontAwesome name="building-o" color="#0A2342" size={20} />
            <TextInput
          ...
          <View style={styles.action}>
            <FontAwesome name="id-card-o" color="#0A2342" size={20} />
            <TextInput
          ...
          <View style={styles.action}>
            <Feather name="mail" color="#0A2342" size={20} />
            <TextInput
